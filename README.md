...
## This is only the frontend, the backend is in [this repo](https://github.com/bahirhakimy/hello-rails-back-end)
...
```bash
git clone https://github.com/muhammedb8826/hello-react-front-end.git
```
